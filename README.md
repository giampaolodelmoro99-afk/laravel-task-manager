...
Il progetto è un sistema di gestione per attività personali (To-Do List) e note correlate.

## 📊 Architettura del Database

* **One-to-Many (1:N): Gestione di Users ↔ Tasks** Un utente può creare e gestire molteplici attività, mentre ogni task appartiene univocamente a un singolo utente. Implementato tramite la chiave esterna `user_id` nella tabella `tasks`.
